...
public class Spt {
	 ...
	 *            返回m个自变量的偏相关系数
	 */
	public static boolean sqt2(double[][] x, double[] y, int m, int n, double[] a,
			double[] dt, double[] v) {
		int i, j, k, mm;
	...
	private static boolean chlk(double[] a, int n, int m, double[] d) {
		int i, j, k, u, v;
	...
	public static void main(String[] args) {
		...
		double[][] x = {{0.0, 0.0}, {364.0, 1747.0}, {61.0, 3805.0}, {1466.0, 18801.0},
				{0.0, 0.0}, {5.0, 12.0}, {35702.0, 57728.0}};
		double[] y = {80.0, 120.0};
		Spt.sqt2(x, y, 7,2, a, dt, v);
